...
public class App {
    public static void main(String[] args) {
        ...
        books[0] = new Book().setTitle("Life is...").setAuthor("Keen Heely").setPages(749).setPrice(124.99);
        books[3] = new Book().setTitle("Key/value").setAuthor("Map").setPrice(12.3).setPages(654);
        Sorter<Book> bookSorter = new Sorter<Book>();
        bookSorter.setComparator(new BookPageComparator()).setArray(books).quickSort(0, books.length - 1).showArray();
    }
}
